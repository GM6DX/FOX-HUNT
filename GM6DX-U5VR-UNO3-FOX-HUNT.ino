/*
  ...
  This sketch was adapted by  fwork of VA6MCP, VE6BTC, AC3DS and GM6DX. 
  March 2021 - . 
*/

#define tonehz 450       // The approximate frequency of the tones in hz. 
#define dit 70         // The length of the dit in milliseconds. The dah and pauses are derived from this.
#define rest 45000       // The amount of time between transmits in ms 60000 = 60seconds
#define longlength 050  // The initial tone which is played to indicate the beginning of a transmission. length of long tone in milliseconds 4000 = 4 seconds
...
String morseTable[] = {"0", "12", "2111", "2121", "211", "1", "1121", "221", "1111", "11", "1222", "212", "1211", "22", "21", "222", "1221", "2212", "121", "111", "2", "112", "1112", "122", "2112", "2122", "2211", "22222", "12222", "11222", "11122", "11112", "11111", "21111", "22111", "22211", "22221", "21121"};


String formMorse(String input);
void playcode(String input);
void playtone(int note_duration);
String Text = " V V V   2M0GUI     FOX   NO    1   PSE R R  K";  // CHANGE THIS TO YOUR CALL SIGN
